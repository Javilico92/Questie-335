...
_GetQuestSoundChoices = function()
    ...
    if Questie.IsCata then
    	options["Goblin Male"] = "Goblin Male"
    	options["Goblin Female"] = "Goblin Female"
    	options["Worgen Male"] = "Worgen Male"
    	options["Worgen Female"] = "Worgen Female"
    	options["Gilnean Male"] = "Gilnean Male"
    	options["Gilnean Female"] = "Gilnean Female"
    end
